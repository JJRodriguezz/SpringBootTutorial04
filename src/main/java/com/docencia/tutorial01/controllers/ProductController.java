...
public class ProductController {
  ...
  // Si vas a añadir dinámicamente, usa una lista mutable
  private static final List<Map<String, String>> products = new ArrayList<>(List.of(
      Map.of("id", "1", "name", "TV", "description", "Best TV", "price", "999"),
      Map.of("id", "2", "name", "iPhone", "description", "Best iPhone", "price", "1299"),
  ...
  public String save(@Valid @ModelAttribute("productForm") ProductForm productForm, BindingResult result, Model model) {
    ...
    model.addAttribute("subtitle", "Product Successfully Created");
